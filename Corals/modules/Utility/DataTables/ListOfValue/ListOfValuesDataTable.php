...
class ListOfValuesDataTable extends BaseDataTable
{
    ...
    public function getFilters()
    {
        return [
            'code' => [
                'title' => trans('Utility::attributes.listOfValue.code'),
                'class' => 'col-md-3',
                'type' => 'text',
                'condition' => 'like',
                'active' => true
            ...
            'label' => [
                'title' => trans('Utility::attributes.listOfValue.label'),
                'class' => 'col-md-3',
                'type' => 'text',
                'condition' => 'like',
                'active' => true
            ...
            'value' => [
                'title' => trans('Utility::attributes.listOfValue.value'),
                'class' => 'col-md-3',
                'type' => 'text',
                'condition' => 'like',
                'active' => true
            ...
            'parent_id' => [
                'title' => trans('Utility::attributes.category.parent_id'),
                'class' => 'col-md-2',
                'type' => 'select',
