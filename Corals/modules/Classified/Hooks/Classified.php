...
class Classified
{
    ...
    public function before_page_content()
    {
        if ($status = ClassifiedFacade::getUserSubscriptionStatus()) {
            $html = view('Classified::subscription_status')->with(compact('status'))->render();
