...
class ClassifiedServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        \Filters::add_filter('dashboard_url', [ClassifiedHook::class, 'auth_redirect_to'], 100);
        \Actions::add_action('before_page_content', [ClassifiedHook::class, 'before_page_content'], 100);
