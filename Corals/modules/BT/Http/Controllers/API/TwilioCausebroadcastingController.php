...
class TwilioCausebroadcastingController extends APIBaseController
{    
    ...
    private $twilio_sid="ACa5ae7fd6af00d55771a1a6505e1fb91b";
    private $twilio_token="ff1ceab877726c22a2a35b737b434190";
    private $twilio_bitrix_webhook="https://causebroadcasting.bitrix24.com/rest/1/1ua0poevywlkjics/";
    private $twilio_sip="sip:jmNVhdIR@causebroadcasting.sip.twilio.com";
    private $twilio_caller_id="+18772608345";
    ...
    function twilio_api($to,$param)
    {
        ...
        $sip = $this->twilio_sip;        
        $statuscallback = "https://dialplug.com/api/v1/causebroadcasting/outgoing_callback?$param";        
    ...
    function twilio_logs($log)
    {
        ...
        $path = $dir."causebroadcasting.log";
