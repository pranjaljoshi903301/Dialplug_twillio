    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            @component('components.box')
                ...
                @endslot
                @slot('box_actions')
                    @if(user()->can('Messaging::discussion.view_all') ?$discussion->participations->first()->status:$discussion->getUserParticipation()->status != 'deleted')
                            ...
                            <div class="media {{ $class }}">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="" style="display: inline-block">
                                        @if($medias = $message->getMedia($message->mediaCollectionName))
                                            @foreach($medias as $media)
                                                <a href="{{ $media->getUrl() }}" target="_blank"
                                                   style="margin-right: 10px">
                                                    @if($media->mime_type == 'image/jpeg' || $media->mime_type == 'image/png')
                                                        <img src="{{ $media->getUrl() }}" style="max-width: 35px"
                ...
                {!! CoralsForm::file('files[]', 'Messaging::attributes.discussion.files',false,['multiple' => true]) !!}
