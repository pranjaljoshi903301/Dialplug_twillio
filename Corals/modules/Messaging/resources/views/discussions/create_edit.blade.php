...
@section('content')
    <div class="row">
        <div class="col-md-2">
            {!! CoralsForm::link(url('messaging/discussions'),'Messaging::labels.discussion.inbox',['class'=>"btn btn-primary btn-block margin-bottom","files" => true]) !!}
        ...
        <div class="col-md-10">
            @component('components.box')
                ...
                @endslot
                {!! CoralsForm::openForm($discussion,["files" => true]) !!}
                @if (isSuperUser())
