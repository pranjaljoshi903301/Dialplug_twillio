                                        ...
                                        @if($status != 'deleted' && isSuperUser())
                                            <a href="{{ url('messaging/discussions/bulk-action/deleted') }}"
                                               ...
                                               class="btn btn-danger btn-sm"><i class="fa fa-trash-o"
                                                                                title="@lang('Messaging::attributes.discussion.status_options.deleted')"></i></a>
                                        @endif
                                        <a href="{{ url('messaging/discussions/bulk-action/read') }}"
                                           data-confirmation="@lang('Messaging::labels.discussion.confirm_read')"
                                           class="btn btn-primary btn-sm m-l-5 ml-2"><i class="fa fa-envelope-open"
                                                                                        title="@lang('Messaging::attributes.discussion.status_options.read')"></i></a>
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($discussions as $discussion)
                                <tr>
                                    ...
                                    <td><b>{{ $discussion->messages()->count() }}</b>
