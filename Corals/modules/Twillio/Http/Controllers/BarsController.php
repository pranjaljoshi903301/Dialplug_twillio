...
namespace Corals\Modules\Twillio\Http\Controllers;
...
class BarsController extends BaseController
{
    ...
    public function __construct(BarService $barService)
    {
        ...
        $this->resource_url = config('twillio.models.bar.resource_url');

        $this->title = "Twillio";
        $this->title_singular = "Twillio";
    ...
    {
        return $dataTable->render('Twillio::bars.index');
    }
    ...
    public function create(BarRequest $request)
    {
        ...
        return view('Twillio::bars.create_edit')->with(compact('bar'));
    }
    ...
    public function show(BarRequest $request, Bar $bar)
    {
        ...
        return view('Twillio::bars.show')->with(compact('bar'));
    }
