...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function registerWidgets()
    {
        ...
        \Shortcode::addWidget('processing_orders', \Corals\Modules\Ecommerce\Widgets\ProcessingOrdersWidget::class);
        \Shortcode::addWidget('pending_orders', \Corals\Modules\Ecommerce\Widgets\PendingOrdersWidget::class);
        \Shortcode::addWidget('cancelled_orders', \Corals\Modules\Ecommerce\Widgets\CancelledOrdersWidget::class);
        ...
        \Shortcode::addWidget('store_revenue', \Corals\Modules\Ecommerce\Widgets\StoreRevenueWidget::class);
    }
    ...
    protected function registerCustomFieldsModels()
    {
        ...
        Settings::addCustomFieldModel(\Corals\Modules\Ecommerce\Models\Shipping::class);
