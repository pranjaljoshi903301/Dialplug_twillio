...
return [
    ...
    'misc' => [
        ...
        'online_refund_not_supported'=>'Online Refund is not supported for gateway :gateway',
        'order_not_paid'=>'Order is not paid yet!',
    ...
    'checkout' => [
        'invalid_coupon' => 'Invalid Coupon Code :code',
    ],
    'order' => [
        'items_required' => 'At least one item should be selected!',
        'item_selection_is_required' => 'You have to Select an item',
    ]
];
