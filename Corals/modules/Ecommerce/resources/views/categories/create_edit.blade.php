            ...
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        {!! CoralsForm::select('category_attributes[]','Ecommerce::attributes.category.filter_attributes', \Ecommerce::getAttributesList(),
false, $category->categoryAttributes()->pluck('attribute_id'), ['multiple'=>true,'help_text'=>'Ecommerce::attributes.category.filter_attributes_help'], 'select2') !!}
