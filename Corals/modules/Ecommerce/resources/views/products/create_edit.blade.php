...
@section('content')
    @parent
    <div class="row">
        <div class="col-md-{{ $product->exists ? '7': '12' }}">
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! CoralsForm::checkbox('shipping[enabled]', 'Ecommerce::attributes.product.shippable', $product->exists ? $product->shipping['enabled'] : false) !!}
