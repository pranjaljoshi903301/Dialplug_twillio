            ...
            <table class="table color-table info-table table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <td class="small-caps table-bg"
                        style="text-align: right">@lang('Ecommerce::labels.checkout.sub_total')</td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="small-caps table-bg"
                        style="text-align: right">@lang('Ecommerce::labels.checkout.discount')</td>
                ...
                <tr class="border-bottom">
                    ...
                    <td></td>
                    <td class="small-caps table-bg"
                        style="text-align: right">@lang('Ecommerce::labels.checkout.total')</td>
