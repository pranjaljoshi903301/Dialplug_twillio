                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @foreach($setting_items as $key => $setting)
                                            @php $setting_concat = 'ecommerce_'.strtolower($setting_key).'_'.$key;  @endphp
                                            ...
                                            @elseif($setting['type'] == 'boolean')
                                                 {!! CoralsForm::boolean($setting_field,$setting['label'],$setting['required'] ?? false, \Settings::get($setting_concat),$attribues) !!}
