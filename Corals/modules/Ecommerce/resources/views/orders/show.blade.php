...
@section('content')
    <div class="row">
        <div class="col-md-8">
            ...
            @component('components.box')
                @slot('box_title')
                    @lang('Ecommerce::labels.order.transactions.title')
                @endslot
                @if($order->transactions)
                    <div class="table-responsive">
                        <table class="table color-table info-table table table-hover table-striped table-condensed">
                            <thead>
                            <tr>
                                <th>@lang('Ecommerce::labels.order.transactions.type')</th>
                                <th>@lang('Ecommerce::labels.order.transactions.amount')</th>
                                <th>@lang('Ecommerce::labels.order.transactions.paid_amount')</th>
                                <th>@lang('Corals::attributes.status')</th>
                                <th>@lang('Ecommerce::labels.order.transactions.reference')</th>
                            </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table color-table info-table table table-hover table-striped table-condensed">
                                ...
                                @isset($order->billing['billing_address'])
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.email')</th>
                                        <td>{{ optional($order->billing['billing_address'])['email'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.first_name')</th>
                                        <td>{{ optional($order->billing['billing_address'])['first_name'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.last_name')</th>
                                        <td>{{ optional($order->billing['billing_address'])['last_name'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.address_one')</th>
                                        <td>{{ optional($order->billing['billing_address'])['address_1'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.address_two')</th>
                                        <td>{{ optional($order->billing['billing_address'])['address_2'] ?? '-' }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.city')</th>
                                        <td>{{ optional($order->billing['billing_address'])['city'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.state')</th>
                                        <td>{{ optional($order->billing['billing_address'])['state'] }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('Ecommerce::attributes.order.zip')</th>
                                        <td>{{ optional($order->billing['billing_address'])['zip'] }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table color-table info-table table table-hover table-striped table-condensed">
                                    ...
                                    @isset($order->shipping['shipping_address'])
                                        <tr>
                                            <th>@lang('Ecommerce::attributes.order.first_name')</th>
                                            <td>{{ optional($order->shipping['shipping_address'])['first_name'] }}</td>
                                        </tr>
                                        <tr>
                                            <th>@lang('Ecommerce::attributes.order.last_name')</th>
                                            <td>{{ optional($order->shipping['shipping_address'])['last_name'] }}</td>
                                        </tr>
                                        <tr>
                                            <th>@lang('Ecommerce::attributes.order.company')</th>
                                            <td>{{ optional($order->shipping['shipping_address'])['company'] }}</td>
                                        </tr>
                                        <tr>
                                            <th>@lang('Ecommerce::attributes.order.address_one')</th>
