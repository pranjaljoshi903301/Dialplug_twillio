...
class TagsDataTable extends BaseDataTable
{
    ...
    {
        return [
            'delete' => ['title' => trans('Corals::labels.delete'), 'permission' => 'Ecommerce::tag.delete', 'confirmation' => trans('Corals::labels.confirmation.title')],
            'active' => ['title' => trans('Corals::attributes.status_options.active'), 'permission' => 'Ecommerce::tag.update', 'confirmation' => trans('Corals::labels.confirmation.title')],
            'inActive' => ['title' => trans('Corals::attributes.status_options.inactive'), 'permission' => 'Ecommerce::tag.update', 'confirmation' => trans('Corals::labels.confirmation.title')]
        ];
    }

    protected function getOptions()
    {
        $url = url(config('ecommerce.models.tag.resource_url'));
