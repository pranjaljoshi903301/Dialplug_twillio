...
class CategoriesDataTable extends BaseDataTable
{
    ...
    {
        return [
            'delete' => ['title' => trans('Corals::labels.delete'), 'permission' => 'Ecommerce::category.delete', 'confirmation' => trans('Corals::labels.confirmation.title')],
            'active' => ['title' => trans('Corals::attributes.status_options.active'), 'permission' => 'Ecommerce::category.update', 'confirmation' => trans('Corals::labels.confirmation.title')],
            'inActive' => ['title' => trans('Corals::attributes.status_options.inactive'), 'permission' => 'Ecommerce::category.update', 'confirmation' => trans('Corals::labels.confirmation.title')]
        ];
    }

    protected function getOptions()
    {
        $url = url(config('ecommerce.models.category.resource_url'));
