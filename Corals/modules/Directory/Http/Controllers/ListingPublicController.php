...
class ListingPublicController extends PublicBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('templates.listings')->with(compact('listings', 'layout', 'sortOptions'));
    }
...
//                ])
//        ]);
        return view('partials.map_item')->with(compact('locationURL', 'locationCategory', 'locationImg', 'locationTitle', 'locationAddress', 'locationPhone', 'locationStarRating'))->render();
    }
