...
<div class="container-fluid pt-2">
    ...
    <div class="box">                          
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="bg-white p-4">
                    <h4>Exotel Configuration [for incoming calls]</h4><hr>
                    <span>Create an Callback URL in your Telephony instance</span><br>
                    <span>Example: Exotel as Telephony Instance</span>
                    <ol>
                        <li>Admin > App Bazzar [<a href="https://my.exotel.com/apps#installed-apps" target="_blank">click here</a>]</li>
