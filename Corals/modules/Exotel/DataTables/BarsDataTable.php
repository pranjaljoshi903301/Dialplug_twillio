...
namespace Corals\Modules\Exotel\DataTables;

use Corals\Foundation\DataTables\BaseDataTable;
use Corals\Modules\Exotel\Models\Bar;
use Corals\Modules\Exotel\Transformers\BarTransformer;
...
class BarsDataTable extends BaseDataTable
{
    ...
    {
        $this->setResourceUrl(config('exotel.models.bar.resource_url'));
