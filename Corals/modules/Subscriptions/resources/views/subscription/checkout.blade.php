            ...
            @component('components.box')
                ...
                <form action="{{ url('subscriptions/do-checkout/'.$plan->hashed_id) }}" method="post" id="payment-form"
				    ...
				    <!-- Changes -->
                		    <div class="row">
		                            <div class="col-md-8">
                		                <p class="bg-info p-10 text-white" style="margin-top: 10px;">
		                                    <span>
                		                        *&nbsp;if you are availing the <b>Free Trial Period</b> the invoice will be
		                                        shared post completion of trial period.
                                		    </span>
                		                </p>
		                            </div>
		                    </div>
