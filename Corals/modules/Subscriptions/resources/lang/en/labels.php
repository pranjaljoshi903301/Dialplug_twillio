...
return [
    ...
    'subscription' => [
        ...
        'subscription_request_received' => 'Your subscription request has been received, and it will be activated when payment acquired<br><br>* if you are availing the Free Trial Period the invoice will be shared post completion of trial period.',
        ...
        'add_new_subscription' => '<i class="fa fa-plus"></i> Select/Add new Subscription',
        ...
        'invoices' => 'Invoices',
        'checkout_details' => 'Review Details',
        'subscription_details' => 'Subscription Details',
        'address_details' => 'Address Details',
        'payment_details' => 'Payment Details',
        'subscribe' => 'Subscribe',
        'check_out' => '<i class="fa fa-check"></i>Proceed to Checkout',
