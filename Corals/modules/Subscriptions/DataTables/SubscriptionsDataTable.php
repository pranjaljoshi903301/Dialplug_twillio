...
class SubscriptionsDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'invoice_status' => ['title' => 'Invoice Status'],
    ...
    {
        return [
            'plan_id' => ['title' => trans('Subscriptions::attributes.subscription.plan_id'), 'class' => 'col-md-2', 'type' => 'select2', 'options' => SubscriptionProducts::getPlansList(), 'active' => true],
            'plan.product_id' => ['title' => trans('Subscriptions::attributes.subscription.product_id'), 'class' => 'col-md-2', 'type' => 'select2', 'options' => SubscriptionProducts::getProductsList(), 'active' => true],
