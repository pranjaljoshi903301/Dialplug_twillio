...
@section('editable_content')
    ...
    <div class="row">
        ...
        <div class="row align-items-end pb-4">
            <div class="col-sm-4">
                <div class="no-margin">
                    {!! CoralsForm::number('quantity','corals-ecommerce-mimity::attributes.template.quantity', false, 1, ['min' => 1,'class'=>'form-control']) !!}
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                @if($product->external_url)
                    <a href="{{ $product->external_url }}" target="_blank" class="btn btn-success"
                       title="@lang('corals-ecommerce-mimity::labels.template.product_single.buy_product')">
                        <i class="fa fa-fw fa-cart-plus"
                           aria-hidden="true"></i> @lang('corals-ecommerce-mimity::labels.template.product_single.buy_product')
                    </a>
                ...
                @else
                    <div class="form-group">
                        {!! CoralsForm::button('corals-ecommerce-mimity::labels.partial.add_to_cart',
