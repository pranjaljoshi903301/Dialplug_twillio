<div class="listar-themepost listar-placespost">
    <figure class="bg listar-featuredimg custom-background-listing-list" data-bg="{{$listing->image}}"
            data-scrollax="properties: { translateY: '30%' }">
        <a href="{{$listing->getShowUrl()}}"></a></figure>
        ...
        <div class="listar-themepostfoot">
            ...
            <div class="listar-postbtns">
                <a class="listar-btnquickinfo" href="#" data-toggle="modal"
                   data-target="#listing-modal-{{$listing->hashed_id}}"><i class="icon-expand"></i></a>
