...
<div class="breaking-news-ticker" id="news">
    <div class="bn-label">@lang('corals-directory-listing-star::labels.template.home.news')</div>
    <div class="bn-news">
        <ul>
...
@elseif(\Settings::get('enable_news_ticker',true) == true &&  (\Settings::get('feed_url_rss')))
    <div class="breaking-news-ticker" id="news">
        <div class="bn-news">
            ...
            <ul>
                <li>
                    <span class="bn-loader-text">@lang('corals-directory-listing-star::labels.template.home.loading')</span>
                </li>
            </ul>
    ...
    <script type="">
        ...
        $('#news').breakingNews({
            source: {
                ...
                errorMsg: '@lang('corals-directory-listing-star::labels.template.home.rss_feed_not_load')'
            }
        });
        @else
        $('#news').breakingNews();
