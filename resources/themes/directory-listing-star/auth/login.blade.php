...
@section('title',trans('corals-directory-listing-star::auth.login'))
            ...
            <div class="col-md-12">
                <div class="login-page">
                    <figure class="listar-loginsingupimg"
                            ...
                            data-vide-options="position: 50% 50%" style="height: 500px"></figure>
                    <div class="listar-contentarea">
                        <div class="listar-themescrollbar">
                            <div class="listar-logincontent">
                                <div class="listar-themetabs" id="custom-padding-login">
                                    <ul class="listar-tabnavloginregistered" role="tablist">
                                        ...
                                        <li role="presentation"><a href="#listar-register"
                                            ...
                                            <form method="POST" action="{{ route('register') }}"
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group listar-inputwithicon {{ $errors->has('terms') ? ' has-error' : '' }}">
                                                        <div class="listar-checkbox">
                                                            <input class="custom-login" name="terms" value="1"
                                                                   id="terms-login"
                                                                   type="checkbox"
                                                                   required>
                                ...
                                <div class="listar-shareor">
                                    <span>@lang('corals-directory-listing-star::labels.template.home.or')</span></div>
