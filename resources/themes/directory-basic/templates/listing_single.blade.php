                ...
                <div class="col-md-4">
                    ...
                    @if(!empty($listing->user_id))
                        <!--box-widget-item -->
                            <div class="box-widget-item fl-wrap">
                                <div class="box-widget-item-header">
                                    <h3>@lang('corals-directory-basic::labels.template.product_single.contact_with',['name' => optional($listing->user)->full_name ] )</h3>
                                </div>
                                <div class="box-widget opening-hours">
                                    <div class="box-widget-content contact">
                                        ...
                                        @if(\Settings::get('directory_messaging_is_enable',true) && (!user() || user()->can('create', Corals\Modules\Messaging\Models\Discussion::class)))
                                            <a href="{{ url('messaging/discussions/create?user='.$listing->user->hashed_id) }}"
            ...
            <div class="main-register fl-wrap">
                ...
                <div id="tabs-container">
                    <div class="custom-form">
                        ...
                        {!! CoralsForm::textarea('brief_description','Directory::attributes.claim.brief_description',true, '', ['rows'=>5]) !!}
