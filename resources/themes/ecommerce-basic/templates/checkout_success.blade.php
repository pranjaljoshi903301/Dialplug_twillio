    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-sm-12">
                ...
                @else
                    <h5 class="text text-info">@lang('corals-ecommerce-basic::labels.template.checkout_success.order_guest_email_sent',['email'=>$order->billing['billing_address']['email']])</h5>
