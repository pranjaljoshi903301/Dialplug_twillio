        ...
        <div class="container padding-bottom-3x mb-2">
            <div class="row justify-content-center">
                <div class=" col-md-6">
                    ...
                    <h2>@lang('corals-ecommerce-basic::labels.auth.reset_password')</h2>
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('password.request') }}" class="login-box"
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-12">
                                <button type="submit"
                                        class="btn btn-primary btn-block btn-flat">@lang('corals-ecommerce-basic::labels.auth.reset_password')</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
