            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="nav-item @if($active_tab=="profile") active @endif">
                        <a href="#profile" class="nav-link" data-toggle="tab">
                            @lang('corals-classified-craigs::auth.profile')
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane @if($active_tab=="profile") active @endif" id="profile">
                            ...
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a href="#edit_profile" class="nav-link active" data-toggle="pill"><i
                                                class="fa fa-pencil"></i> @lang('corals-classified-craigs::auth.edit_profile')
                                    </a></li>
                                <li class="nav-item">
                                    <a href="#profile_addresses" class="nav-link" data-toggle="pill"><i
                                                class="fa fa-map-marker"></i>
                                        @lang('corals-classified-craigs::auth.addresses')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#reset_password" class="nav-link" data-toggle="pill"><i
                                                class="fa fa-lock"></i>
                                        @lang('corals-classified-craigs::auth.auth_password')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#notification_preferences" class="nav-link" data-toggle="pill"><i
                                                class="fa fa-bell-o"></i>
                                        @lang('corals-classified-craigs::auth.notification_preferences')</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="edit_profile">
                                    <div class="row">
                                        ...
                                        <div id="country-div" class="col-md-4">
                                            ...
                                            {!! CoralsForm::text('properties[store_name]','corals-classified-craigs::labels.profile.store_name') !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center">
                                                ...
                                                <small class="">@lang('corals-classified-craigs::auth.click_pic_update')</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="notification_preferences">
                                    ...
                                    @empty
                                        <h5>@lang('corals-classified-craigs::auth.no_notification')</h5>
                                    @endforelse
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {!! CoralsForm::formButtons(trans('corals-classified-craigs::auth.save',['title' => $title_singular]),[],['href'=>url('dashboard')]) !!}
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>@lang('corals-classified-craigs::auth.change_image')</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="actions my-3">
                        <span class="btn btn-info btn-file">@lang('corals-classified-craigs::auth.browse_files')
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary m-r-10 m-l-10"
                            id="Save">@lang('corals-classified-craigs::auth.save',['title'=>''])</button>
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('corals-classified-craigs::auth.close')</button>
                </div>
            </div>
        </div>
    </div>
