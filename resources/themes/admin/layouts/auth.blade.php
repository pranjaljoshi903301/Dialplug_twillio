...
<div class="login-box">
    <!-- /.login-logo -->
    <a href="/"">
        <h1 class="text-center" style="margin-bottom: 20px; font-size: 40px">
            <span style="color: #0E2D7B">Dial</span>
            <span style="color: #7DBA00">Plug</span>
        </h1>
    </a>
    <div class="login-box-body">
        {{-- <a href="/"">
            <h1 class="text-center" style="margin-bottom: 20px; font-size: 40px">
                <span style="color: #7DBA00">Dial</span>
                <span style="color: #7DBA00">Plug</span>
            </h1>
        </a> --}}
