...
<div class="container-fluid pt-2">
    ...
    <div class="box">                          
        <div class="heading">
            <h4 class="text-style">Exotel Agents Details</h4>
        ...
        <table id="datatable" class="table table-hover bg-white table-responsive">
            <thead>
            <tr>
                <th>S.No</th>
                <th>Agent Email</th>
            ...
            @php $i++; @endphp
            <tr>
                <td>{{$i}}<input type="hidden" value="{{$agent['ID']}}" name="agentid_{{$i}}" id="agentid_{{$i}}">
                ...
                <td><input type="number" value="{{$agent['agent_phone']}}" class="form-control" name="agentphone_{{$i}}" id="agentphone_{{$i}}" placeholder="Agent Phone"></td>                  
