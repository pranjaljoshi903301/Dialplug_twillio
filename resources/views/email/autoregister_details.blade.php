...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      ...
      Thank you for registering at Dialplug. We're glad to host you on our seamless Dialplug Telephony solution. We are excited to have you on-board with us.
      <p
        style="font-weight: 400; font-size: 16px; line-height: 24px; color: rgb(119, 119, 119);">
            <strong>Dialplug Login Credentials : </strong>
            <br>
            ====================================================
            <br>
