...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      ...
      Hi Tech Admin,</p><p class="size-18" style="Margin-top: 20px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-18"><em>{!! $body !!}</em></p><p class="size-18" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;" lang="x-size-18">&nbsp;</p>
      Details : <br>
      User ID = {{ $logged_user_id }}<br>
      Name  = {{ $name }}<br>
      Email ID = {{ $logged_user_email }}<br>
