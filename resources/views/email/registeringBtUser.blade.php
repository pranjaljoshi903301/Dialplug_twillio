...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      {{-- <p class="size-18" style="Margin-top: 20px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-18">&nbsp;<br /> --}}
      Hi {{ $name }}</p>
      <p class="size-18" style="Margin-top: 20px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-18">
        Thanks for creating/editing a Bitrix User for telephony, We will email you soon with
        <ul>
          <li>Url</li>
          <li>Username</li>
          <li>Password</li>
        </ul>
        for setting up Softphone with your own Cloud Hosted FreePBX
      <p class="size-18" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;" lang="x-size-18">&nbsp;</p>
    </div>
  </div>
